...
const shared = {
  ...
  installerUrl:
    "https://github.com/Retrofight/retrofight-releases/releases/latest/download/RetroFight-win-x64.exe",
  portableUrl:
    "https://github.com/Retrofight/retrofight-releases/releases/latest/download/RetroFight-win-x64.zip",
};
